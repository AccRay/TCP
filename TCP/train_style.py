...
class TCP_planner(pl.LightningModule):
	def __init__(self, config, lr):
		...
		self.ckpt = torch.load('/data1/wyz/TCP/log/Test2_Basic/epoch=59-last.ckpt')
		ckpt = self.ckpt["state_dict"]
...
if __name__ == "__main__":
	...
	parser.add_argument('--id', type=str, default='Test3_aggressive', help='Unique experiment identifier.')
	...
	parser.add_argument('--logdir', type=str, default='log/TCP_aggressive', help='Directory to log data to.')
