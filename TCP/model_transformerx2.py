...
class TransformerBlock(nn.Module):
	def __init__(self):
		super().__init__()
		self.layernorm1 = nn.LayerNorm([9, 32])
		self.layernorm2 = nn.LayerNorm([9, 32])
...
class TCP(nn.Module):
	...
	def __init__(self, config):
		...
		self.env_feature = nn.Linear(288, 1024)
		self.env_feature2 = nn.Linear(288, 576)
	...
	def forward(self, is_junction, vehicles, walkers, stops, max_speed, stop_sign, yield_sign,
		...
		feature_emb = feature_emb.reshape(-1, 288)
